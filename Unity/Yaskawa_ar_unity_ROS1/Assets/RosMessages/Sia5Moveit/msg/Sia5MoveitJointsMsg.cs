...
{
    [Serializable]
    public class Sia5MoveitJointsMsg : Message
    {
        public const string k_RosMessageName = "sia5_moveit/Sia5MoveitJoints";
        ...
        public Sia5MoveitJointsMsg(double[] joints, Geometry.PoseMsg pick_pose, Geometry.PoseMsg place_pose)
        {
            this.joints = joints;
        ...
        public static Sia5MoveitJointsMsg Deserialize(MessageDeserializer deserializer) => new Sia5MoveitJointsMsg(deserializer);

        private Sia5MoveitJointsMsg(MessageDeserializer deserializer)
        {
